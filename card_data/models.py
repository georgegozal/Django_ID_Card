...
class UserInfo(models.Model):  
    ...
    def __str__(self):
        return self.info
#პირველი ცვლა, ნახევარ განაკვეთზე, სტაჟიორი, მართვის მოწმობით 
class IdCard(models.Model):
    ...
    sex         = models.CharField(null=False,choices=(('female','female'),('male','male')),max_length=20)
    photo       = models.ImageField(upload_to='images/')
    department  = models.ForeignKey('Department', on_delete=models.SET_NULL, null=True)
    #drivers_license = models.CharField(max_length=20, null=False, choices =(('Yes','Yes'),('No','No')))
    other_info  = models.ManyToManyField(UserInfo,related_name='other_info')
